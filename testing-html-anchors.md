...
## <a name="the-generated-toc-copy-pasted"></a>The generated ToC (copy-pasted)
...
## <a name="foreign-characters"></a>Foreign characters
### <a name="accents-äöüßäöüß-áéíóú-áéíóú-àèìòù-ññõõ-çç-øø"></a>Accents: äöüßÄÖÜẞ áéíóú ÁÉÍÓÚ àèìòù ñÑõÕ çÇ øØ
### <a name="russian-какой-то-русский-текст"></a>Russian: Какой-то русский текст…

## <a name="numbers-0123--ⅰ-ⅱ-ⅲ-ⅰ-ⅱ-ⅲ--"></a>Numbers: 0123 ⑴⑵⑶ ⅰ ⅱ ⅲ Ⅰ Ⅱ Ⅲ ²³ ¼½

## <a name="underscore-within-code-tags"></a>Underscore within code tags
### <a name="some-code_with_underscores--ab"></a>Some `code_with_underscores += a*b`
### <a name="more-code_bars"></a>More `code_bars`
### <a name="we-might-have-double_quoted_code"></a>We might have ``double_quoted_code``
### <a name="or-even-double-quoted-with-single-backticks--inside"></a>Or even ``double-quoted with single backticks ` inside!``

## <a name="underscore-special-cases"></a>Underscore special cases
### <a name="just-__-some-underlines-or-dunders"></a>Just __ some underlines, or __dunders__
### <a name="___"></a>___
### <a name="__"></a>__
### <a name="dunder"></a>__dunder__
### <a name="emphasis"></a>_emphasis_
### <a name="_-emph-_"></a>_ emph _
### <a name="in-a-sentence"></a>_in a *sentence*_
### <a name="in_word_parsing"></a>_in_word_parsing_
### <a name="another_in_word_example"></a>_another_in_word_example_
...
### <a name="some-emphasized-text"></a>Some _emphasized_ text
### <a name="some-bold-text"></a>Some **bold** text
### <a name="some-strikethrough-text"></a>Some ~~strikethrough~ text
### <a name="anchors-anchors"></a>Anchors {#anchors}
### <a name="anchors"></a>Anchors

## <a name="more-character-codes"></a>More character codes
### <a name="apostrophes-and-such-a-b-c-d-e-f-g-h"></a>Apostrophes and such: "a" 'b' “c” ‘d’ »e« ›f‹ „g“ ‚h‘
### <a name="parentheses-brackets-and-curlies"></a>(Parentheses), [brackets] and {curlies}
### <a name="arrows---"></a>Arrows: ←↓↑→ ↕⇵ ⏎
### <a name="symbols---"></a>Symbols: ☯ ☎ 🂡
### <a name="currency-----"></a>Currency: $ € £ ₽ ¤
### <a name="other-"></a>Other: ℗©™

## <a name="repeated-headings"></a>Repeated Headings
...
### <a name="heading-1"></a>Heading

This generates `#heading-1`.

### <a name="heading-2"></a>Heading

This generates `#heading-2`.

### <a name="heading-2-1"></a>Heading 2

This _would_ generate `#heading-2`, but since that has been used already, it now generates `#heading-2-1`.

### <a name="heading-3"></a>Heading

This generates `#heading-3` as expected.

## <a name="numbered-headings"></a>Numbered Headings

### <a name="3-a-section"></a>3. A section
#### <a name="31-sub-section"></a>3.1 Sub-section
##### <a name="311-sub-sub-section"></a>3.1.1 Sub-sub-section
##### <a name="312-sub-sub-section"></a>3.1.2 Sub-sub-section
##### <a name="313-sub-sub-section"></a>3.1.3 Sub-sub-section
#### <a name="32-sub-section"></a>3.2 Sub-section
##### <a name="321-sub-sub-section"></a>3.2.1 Sub-sub-section
##### <a name="322-sub-sub-section"></a>3.2.2 Sub-sub-section
##### <a name="323-sub-sub-section"></a>3.2.3 Sub-sub-section
...
## <a name="back-again-from-the-code-blocks"></a>Back again from the code blocks

## <a name="indentation-4-spaces-is-code"></a>Indentation (4+ spaces is code)

### <a name="none"></a>None

 ### <a name="1-space"></a>1 space

  ### <a name="2-spaces"></a>2 spaces

   ### <a name="3-spaces"></a>3 spaces
...
## <a name="dummy-text-so-we-can-see-the-browser-jump-to-the-desired-heading"></a>Dummy text so we can see the browser jump to the desired heading
